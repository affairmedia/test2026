...
import { AlarmCreateScreenProps } from '../navigation/types';
...
const AlarmCreateScreen: React.FC<AlarmCreateScreenProps> = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['bottom']}>
      ...
      >
        ...
        >
          <Text style={styles.title}>Nouvelle Alarme</Text>
